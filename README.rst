...
* **Optimization Process phase**, realiza uma sequência de iterações em busca de otimizar/encontrar os melhores resultados. Além disso, esta etapa consiste em 3 processos essenciais:
    1. teste
